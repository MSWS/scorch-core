...
public class PermissionPlayer {
    ...
    /**
     * Removes the group and all of its permissions + inherited groups from the player
    ...
    /**
     * Removes the player from all groups and only adds them back to the group given.
    ...
    public void updatePermissions () {
        ScorchCore.getInstance().getDataManager().updateObjectAsync("permissions", this, new SQLSelector(("uniqueId"), getUniqueId()));
