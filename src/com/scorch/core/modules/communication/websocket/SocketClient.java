...
public class SocketClient extends WebSocketClient {
    ...
    public void onOpen(ServerHandshake serverHandshake) {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                try {
                    ScorchCore.getInstance().getCommunicationModule().dispatchEvent(new PermissionUpdateEvent("gamergirl"));
    ...
    public void onMessage(String message) {
        ...
        if(PacketUtils.getPacketType(message).equals("EventPacket")){
            JsonObject event = gson.fromJson(gson.fromJson(message, JsonObject.class).get("event").getAsString(), JsonObject.class);
